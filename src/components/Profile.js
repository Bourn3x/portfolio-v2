  ...
  return (
    <motion.div
      ...
      <div className="px-32 pt-32 pb-40">
        <motion.h1 variants={motionProfileItem} className="text-7xl text-lotion-white font-bold relative header">
          Full Stack Developer
          <span className="text-accent-1 ml-1 font-sans">.</span>
        </motion.h1>
        <motion.div variants={motionProfileItem} className="header-underline"/>
        <motion.h2 variants={motionProfileItem} className="text-2xl text-lotion-white font-bold ml-1 mt-8">
          Hi, I’m Julian! <br/>
